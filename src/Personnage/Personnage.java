...
public abstract class Personnage implements PersonnageInterface {
	...
	public void killer() {
		...
		JournalisationSingleton.getInstance().journaliser("Nombre de killer:" + getKiller() + "\n");
	}

	@Override
	public void seReposer() {
		JournalisationSingleton.getInstance().journaliser("Je me repose Zzzzzzz\n");
		this.force = this.force + 10;
		this.vie = this.vie + 10;
	}
